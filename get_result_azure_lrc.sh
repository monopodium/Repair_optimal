...
result_path='/home/msms/codes/Repair_optimal/result_azure_lrc_sub.txt'
RUN_TIMES=10
NETWORKCORE_IP='10.0.0.61'
PLACEMENT_PLAN=('Best_Placement' 'Random' 'Flat' 'Sub_Optimal')
...
N_K_R_ARRAY=('8 3 3' '9 4 2' '12 6 3' '16 12 6' '20 12 3' '24 15 5')
# N_K_R_ARRAY=('16 12 6')
# PLACEMENT_PLAN=('Sub_Optimal')
...
do
    ...
    do
        ...
        pkill -9 client
        echo './prototype/cmake/build/client true '$ENCODE_TYPE' '$placement' '$n_k_r' '$block_size' '$RUN_TIMES' '$result_path''>>$result_path
        echo './prototype/cmake/build/client true '$ENCODE_TYPE' '$placement' '$n_k_r' '$block_size' '$RUN_TIMES''
        ./prototype/cmake/build/client true $ENCODE_TYPE $placement $n_k_r $block_size $RUN_TIMES $result_path
    done
    block_size=4096
