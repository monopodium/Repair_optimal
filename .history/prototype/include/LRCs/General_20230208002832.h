...
namespace REPAIR
{
    ...
    public:
        ...
        virtual void set_parameter(int n_in, int k_in, int r_in, int w = 8);
        virtual std::pair<double, double> return_DRC_NRC(REPAIR::PlacementType placement_type, int random_seed = 10, bool if_debug = false);
        virtualREPAIR::Placement generate_placement(REPAIR::PlacementType placement_type, int random_seed = 10);
