...
PYBIND11_MODULE(Code_parameters, m)
{
    ...
    pybind11::class_<CodePyInterface>(m, "CodePyInterface")
        ...
        .def("generate_placement", &CodePyInterface::generate_placement)
        .def("return_repair_request", &CodePyInterface::return_repair_request)
        .def("calculate_distance", &CodePyInterface::calculate_distance)
        ...
        .def("repair_request", &CodePyInterface::repair_request)
