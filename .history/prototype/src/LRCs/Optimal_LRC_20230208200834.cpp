...
namespace REPAIR
{
    ...
    void Optimal_LRC_Class::nkr_to_klgr(int n, int k, int r, int &l, int &g)
    {
        l = ceil(n, (r + 1));
        g = n - k - l;
    };
    void Optimal_LRC_Class::klgr_to_nkr(int k, int l, int g, int r, int &n)
    {
        n = k + l + g;
    };
    void Optimal_LRC_Class::generate_stripe_information()
    {
        ...
        if (m_stripe_information.size() != l)
        {
